...
int main(int argc, char *argv[])
{
    ...
    char *a = get_abs_path("input/parrot10.bmp");
    printf("%s\n", a);

    // char *if_rgb_path = get_abs_path("input/parrot10.bmp");
    // char *of_cb_path = get_abs_path("input/parrot10.bmp");
    // char *of_cr_path = get_abs_path("input/parrot10.bmp");
    // char *of_lum_path = get_abs_path("input/parrot10.bmp");
    // char *of_rgb_path = get_abs_path("input/parrot10.bmp");
