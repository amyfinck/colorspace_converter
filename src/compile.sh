...
/opt/arm/4.3.2/bin/arm-linux-gcc -static -O3 -I/tmp/tmp_dir /tmp/tmp_dir/colorspace_converter.c /tmp/tmp_dir/bmp_parser.c /tmp/tmp_dir/converters.c /tmp/tmp_dir/transformers.c /tmp/tmp_dir/utilities.c -o cc.exe
